 ...
 */
export const TEMPLATE_PADRAO = `Olá, {cliente}! Passando para lembrar que a sua continha de {valor} na adega está em aberto. Segue o pix para pagamento osbrothersadega@gmail.com`;
